...
<mark style="background: #FFF3A3A6;">Paso 1</mark>: Crear un SRS. El documento de requerimientos fue la base que utilizaron para luego comparar y validar los resultados de las pruebas. Básicamente, ayudo a definir los criterios de aceptación para indicar cuando un requerimiento estaba cumplido. En este caso, se desarrollo el método para crear el SRS.

<mark style="background: #FFF3A3A6;">Paso 2</mark>: Separa responsabilidades, modular y diseñar interfaces. La base del proyecto fue un diseño orientado a objetos, preparado para ser adaptado a futuras funcionalidades.

<mark style="background: #FFF3A3A6;">Paso 3</mark>: 
